...
CMSIS_DSP_INCLUDE_DIR = $(CMSIS_DSP_DIR)/Include
CMSIS_DSP_PRIVATE_INCLUDE_DIR = $(CMSIS_DSP_DIR)/PrivateInclude
CMSIS_DSP_COMPUTELIB_INCLUDE_DIR = $(CMSIS_DSP_DIR)/ComputeLibrary/Include
CMSIS_DSP_SOURCE_DIR = $(CMSIS_DSP_DIR)/Source
CMSIS_DSP_COMPUTELIB_SRC_DIR = $(CMSIS_DSP_DIR)/ComputeLibrary/Source
